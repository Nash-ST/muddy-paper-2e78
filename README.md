...
```
npm create cloudflare@latest -- --template=cloudflare/templates/muddy-paper-2e78
```

A live public deployment of this template is available at [https://muddy-paper-2e78.templates.workers.dev](https://muddy-paper-2e78.templates.workers.dev)
